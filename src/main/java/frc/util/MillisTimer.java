...
public class MillisTimer {
	...
	//1000000000 division
	public double get() {
		return passedTime + ((System.nanoTime() /1000000000.0) - startingTime);
	}
	...
	public void start() {
		if(!isRunning) {
			isRunning = true;
			startingTime = System.nanoTime() / 1000000000.0;
		} else {
	...
	public void stop() {
		if(isRunning) {
			isRunning = false;
			passedTime += ((System.nanoTime() /1000000000.0) - startingTime);
		} else {
